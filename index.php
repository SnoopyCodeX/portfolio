...
<body>
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#s-about">about</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#s-services">services</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#s-projects">projects</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#s-contact">contact</a>
                        </li>
    ...
    <main class="site-main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-md-12 site-title">
                        ...
                        <h1 class="title-text text-uppercase">I am John Roy</h1>
                        <h4 class="title-text text-uppercase">Freelance Developer</h4>
                        <div class="site-buttons">
                            <div class="d-flex flex-row flex-wrap">
                                <button type="button" id="hire" class="btn button primary-button mr-4 text-uppercase">Hire me</button>
                                <button type="button" id="getcv" class="btn button secondary-button text-uppercase">Get cv</button>
                            </div>
                        </div>
                    </div>
        ...
        <section class="about-area" id="s-about">
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-12 about-title">
                        ...
                        <button type="button" id="downloadcv" class="btn button primary-button text-uppercase">Download cv</button>
                    </div>
                </div>
            </div>
        </section>
                        ...
                        <div class="first-row row">
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-html5 fa-lg"></i></h2>
                                    <p class="text-muted">HTML5</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-css3-alt fa-lg"></i></h2>
                                    <p class="text-muted">CSS3</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-js-square fa-lg"></i></h2>
                                    <p class="text-muted">Javascript</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-laravel fa-lg"></i></h2>
                                    <p class="text-muted">Laravel</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-bootstrap fa-lg"></i></h2>
                                    <p class="text-muted">Bootstrap</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-vuejs fa-lg"></i></h2>
                                    <p class="text-muted">VueJS</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-php fa-lg"></i></h2>
                                    <p class="text-muted">PHP</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fas fa-server fa-lg"></i></h2>
                                    <p class="text-muted">MySQL DB</p>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="single-brand">
                                    <h2 class="text-muted"><i class="fab fa-java fa-lg"></i></h2>
                        ...
                        <div class="experience-area">
                            ...
                            <div class="d-flex flex-row flex-wrap call-area">
                                ...
                                <div class="call-now">
                                    ...
                                    <span class="font-roboto py-2">(+63)-905-857-2372</span>
                                </div>
                            </div>
        ...
        <section class="services-area" id="s-services">
            <div class="container">
                <div class="row">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase font-roboto">Website Developer</h5>
                                    <p class="card-text text-secondary">
                                        Hire me as a Website Developer. I can make you your website using Laravel, PHP, MySQL, HTML, CSS and Javascript.
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            <div class="services">
                                ...
                                <div class="card-body text-center">
                                    <h5 class="card-title text-uppercase font-roboto">Mobile App Developer</h5>
                                    <p class="card-text text-secondary">
                                        Hire me as a Mobile App Developer. I can make you your app using Java + XML and/or Flutter.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <section class="project-area" id="s-projects">
            <div class="container">
                ...
                <div class="row grid">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item latest">
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link">
                                    <img src="./img/svg/fitness.svg" alt="portfolio-1" class="img-fluid" width="200" height="200">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase">Doctor Appointment</h4>
                                <span class="text-secondary">Latest, Mobile App</span><br>
                                <a href="https://github.com/SnoopyCodeX/appointment-app" class="btn btn-outline-warning">See Project</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item latest">
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link">
                                    <img src="./img/svg/web_scraping.svg" alt="portfolio-1" class="img-fluid" width="200" height="200">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase">CoViD-19 Tracker</h4>
                                <span class="text-secondary">Latest, Mobile App</span><br>
                                <a href="https://github.com/SnoopyCodeX/covid19tracker" class="btn btn-outline-warning">See Project</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 element-item latest">
                        <div class="our-project">
                            <div class="img">
                                <a class="test-popup-link">
                                    <img src="./img/svg/music.svg" alt="portfolio-1" class="img-fluid" width="200" height="200">
                                </a>
                            </div>
                            <div class="title py-4">
                                <h4 class="text-uppercase">Virtual RVM</h4>
                                <span class="text-secondary">Latest, Mobile App</span><br>
                                <a href="https://github.com/SnoopyCodeX/virtualrvm" class="btn btn-outline-warning">See Project</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container subscribe">
                <div class="row">
                    <div class="col-lg-12 text-center subscribe-title">
                        ...
                        <p class="para">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam, consequuntur.
                        </p>
                    </div>
                </div>
    ...
    <footer class="footer-area" id="s-contact">
        <div class="container">
            <div class="">
                <div class="social text-center">
                    <h5 class="text-uppercase">Contact me</h5>
                    <a href="https://www.facebook.com/johnroycalimlim"><i class="fab fa-facebook"></i></a>
                    <a href="https://www.github.com/SnoopyCodeX"><i class="fab fa-github"></i></a>
                    <a href="https://www.youtube.com/channel/UCC65iAfGIHvMCi1vV-I8OSQ"><i class="fab fa-youtube"></i></a>
                    <a href="mailto:johnroy062102calimlim@gmail.com"><i class="fas fa-envelope"></i></a>
                </div>
